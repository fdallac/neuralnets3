...
template<typename T>
T MSELoss<T>::forward(const Matrix<T>& predictions, const Matrix<T>& targets) {
...
template<typename T>
Matrix<T> MSELoss<T>::backward(const Matrix<T>& predictions, const Matrix<T>& targets) {
    if (predictions.rows() != targets.rows() || predictions.cols() != targets.cols()) {
...
template<typename T>
T CrossEntropyLoss<T>::forward(const Matrix<T>& predictions, const Matrix<T>& targets) {
    if (predictions.rows() != targets.rows() || predictions.cols() != targets.cols()) {
...
template<typename T>
Matrix<T> CrossEntropyLoss<T>::backward(const Matrix<T>& predictions, const Matrix<T>& targets) {
    if (predictions.rows() != targets.rows() || predictions.cols() != targets.cols()) {
