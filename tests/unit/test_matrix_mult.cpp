...
TEST(MatrixMultiplication, UnrolledMultiplication) {
    ...
    Matrix<int> D = MatMul<int>::mm(A, B, MatMulMethod::LoopUnrolledN, 4); // Using default multiplication for verification
...
TEST(MatrixMultiplication, Unrolled8Multiplication) {
    ...
    Matrix<int> D = MatMul<int>::mm(A, B, MatMulMethod::LoopUnrolledN, 8); // Using default multiplication for verification
    Matrix<int> E = MatMul<int>::mm(A, B); // Using default multiplication for verification
